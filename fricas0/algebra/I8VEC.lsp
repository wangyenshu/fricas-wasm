...
(DEFUN |I8Vector;| ()
  (SPROG
   ((|dv$| NIL) (% NIL) (#1=#:G2523 NIL) (#2=#:G2522 NIL) (#3=#:G2521 NIL)
    (|pv$| NIL))
   (PROGN
    (LETT |dv$| '(|I8Vector|))
    (LETT % (GETREFV 34))
...
(MAKEPROP '|I8Vector| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|NonNegativeInteger|) |I8VEC;#;%Nni;1|
              ...
              (|Boolean|) (|Mapping| 8 8) (|List| 8) (|Union| 8 '"failed")
              (|Mapping| 17 8) (|UniversalSegment| 8) (|List| %)
              (|Mapping| 8 8 8) (|Mapping| 17 8 8) (|HashState|)
