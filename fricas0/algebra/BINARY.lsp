...
(MAKEPROP '|BinaryExpansion| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|RadixExpansion| '2) (|Fraction| 14)
           ...
           '#(~= 5 |zero?| 11 |wholePart| 16 |unitNormal| 21 |unitCanonical| 26
              ...
              |denom| 502 |convert| 507 |conditionP| 532 |commutator| 537
              |coerce| 543 |charthRoot| 578 |characteristic| 583 |ceiling| 587
              |binary| 592 |associator| 597 |associates?| 604 |antiCommutator|
              610 |annihilate?| 616 |abs| 622 ^ 627 |Zero| 645 |One| 649 D 653
              >= 703 > 709 = 715 <= 721 < 727 / 733 - 745 + 756 * 762)
           'NIL
           (CONS
            (|makeByteWordVec2| 25
