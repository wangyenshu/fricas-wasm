...
(DEFUN |I8Matrix;| ()
  (SPROG
   ((|dv$| NIL) (% NIL) (#1=#:G2550 NIL) (#2=#:G2551 NIL) (#3=#:G2549 NIL)
    (|pv$| NIL))
   (PROGN
    (LETT |dv$| '(|I8Matrix|))
    (LETT % (GETREFV 46))
...
(MAKEPROP '|I8Matrix| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|Integer|) |I8MAT;minRowIndex;%I;1|
              ...
              |I8MAT;new;2NniI%;13| (|Boolean|) (|Mapping| 6 6) (|List| 25)
              (|I8Vector|) (|List| 6) (|Segment| 6) (|List| 26) (|List| %)
              (|List| 28) (|List| 9) (|PositiveInteger|) (|Mapping| 6 6 6)
              (|Void|) (|List| 30) (|Union| 6 '"one") (|List| 37)
              (|Equation| 6) (|Mapping| 21 6) (|Mapping| 21 6 6) (|OutputForm|)
              (|List| 24) (|Union| % '"failed") (|HashState|) (|SingleInteger|)
              (|String|))
