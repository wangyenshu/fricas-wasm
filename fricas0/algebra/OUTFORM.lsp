...
(SDEFUN |OUTFORM;convert;%If;14| ((|a| (%)) (% (|InputForm|)))
        (SPROG
         ((#1=#:G1613 NIL) (|b| (|SExpression|)) (|d| (|String|))
          (|l| (|Integer|)) (|c| (|String|)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| |a|)
...
(SDEFUN |OUTFORM;matrix;L%;26| ((|ll| (|List| (|List| %))) (% (%)))
        (SPROG ((|lv| (|List| %)) (#1=#:G1632 NIL) (|l| NIL) (#2=#:G1631 NIL))
               (SEQ
                 ...
                 (SEQ
                  (LETT |e|
                        (COND ((IDENTP |a|) |a|) ((STRINGP |a|) (INTERN |a|))
                              (#2='T (PROGN (LETT #1# NIL) (GO #3=#:G1687)))))
...
(SDEFUN |OUTFORM;differentiate;%Nni%;91|
        ((|a| (%)) (|nn| (|NonNegativeInteger|)) (% (%)))
        (SPROG ((|s| (|String|)) (|r| (|String|)) (#1=#:G1720 NIL))
               (SEQ
                (COND ((ZEROP |nn|) |a|)
...
(MAKEPROP '|OutputForm| '|infovec|
          (LIST
           ...
           '#(~= 153 |zag| 165 |vspace| 171 |vconcat| 176 |tensor| 187
              ...
              |hconcat| 491 |exquo| 502 |empty| 508 |elt| 512 |dot| 518
              |differentiate| 529 |convert| 535 |commaSeparate| 540 |coerce|
              545 |center| 550 |bracket| 561 |brace| 571 |box| 581
              |blankSeparate| 586 |binomial| 591 |assign| 597 |and| 603 ^ 609
              SEGMENT 615 >= 626 > 632 = 638 <= 650 < 656 / 662 - 668 + 679 *
              685)
           'NIL
           (CONS (|makeByteWordVec2| 1 '(0 0 0 0))
                 (CONS '#(|SetCategory&| NIL NIL |BasicType&|)
                       (CONS
                        '#((|SetCategory|) (|CoercibleTo| 21)
                           (|ConvertibleTo| 43) (|BasicType|))
                        (|makeByteWordVec2| 147
                                            '(2 6 0 2 0 7 1 12 11 0 13 1 8 0 18
                                              ...
                                              135 1 12 0 0 136 2 0 11 0 0 1 2 0
                                              0 0 0 91 2 0 0 0 0 125 1 0 0 23
                                              56 2 0 0 0 0 57 1 0 0 18 90 2 0 0
                                              0 0 147 2 0 0 0 18 88 2 0 0 0 0
                                              78 2 0 0 0 0 139 1 0 0 0 138 3 0
                                              0 0 0 0 140 2 0 0 0 0 77 2 0 0 0
                                              0 129 1 0 0 18 64 2 0 0 0 18 84 2
                                              0 0 23 23 58 1 0 0 0 126 2 0 0 0
                                              0 127 2 0 0 0 23 52 1 0 0 0 55 2
                                              0 0 0 0 102 2 0 0 0 0 132 1 0 0 0
                                              117 2 0 0 0 0 103 2 0 0 0 0 142 1
                                              0 0 0 141 3 0 0 0 0 0 143 1 0 9 0
                                              10 1 0 0 0 121 2 0 0 0 85 120 2 0
                                              0 0 0 80 2 0 0 0 0 79 2 0 0 0 18
                                              113 2 0 0 0 0 116 1 0 0 18 62 1 0
                                              0 0 75 1 0 0 18 76 2 0 0 0 0 123
                                              1 0 0 0 118 2 0 0 0 0 128 1 0 0
                                              23 24 1 0 0 12 31 1 0 0 25 26 2 0
                                              0 0 0 106 1 0 0 0 107 1 0 9 12 16
                                              1 0 0 12 15 1 0 0 60 61 2 0 0 0
                                              23 51 1 0 0 0 54 1 0 12 0 1 2 0 0
                                              0 0 131 2 0 0 0 0 145 1 0 0 0 144
                                              3 0 0 0 0 0 146 1 0 11 0 111 2 0
                                              0 0 18 114 3 0 0 0 0 0 115 1 0 0
                                              23 48 2 0 0 0 0 49 1 0 0 18 89 2
                                              0 0 0 0 104 0 0 0 14 2 0 0 0 18
                                              112 2 0 0 0 85 122 1 0 0 0 119 2
                                              0 0 0 85 137 1 0 43 0 47 1 0 0 18
                                              63 1 0 21 0 22 2 0 0 0 23 50 1 0
                                              0 0 53 1 0 0 0 74 1 0 0 18 59 1 0
                                              0 18 73 1 0 0 0 72 1 0 0 0 124 1
                                              0 0 18 71 2 0 0 0 0 110 2 0 0 0 0
                                              130 2 0 0 0 0 105 2 0 0 0 0 101 2
                                              0 0 0 0 108 1 0 0 0 109 2 0 0 0 0
                                              95 2 0 0 0 0 93 2 0 11 0 0 17 2 0
                                              0 0 0 20 2 0 0 0 0 94 2 0 0 0 0
                                              92 2 0 0 0 0 100 2 0 0 0 0 97 1 0
                                              0 0 98 2 0 0 0 0 96 2 0 0 0 0
                                              99)))))
           '|lookupComplete|)) 
