...
(DEFUN |InvestigateConditions| (|catvecListMaker| |base_shell| |e|)
  (PROG (|principal| |secondaries| |op| |LETTMP#1| |principal'| |cond| |new|
         ...
         |MinimalPrimaries| |HackSlot4| |v| |partList| |masterSecondaries|
         |list| |w|)
    (RETURN
     (PROGN
                   ...
                   (PROGN
                                           ...
                                           ((LAMBDA (|bfVar#69| |bfVar#68| |w|)
                                              (LOOP
                                               ...
                                               (SETQ |bfVar#68|
                                                       (CDR |bfVar#68|))))
                                            NIL |u| NIL))
                                   (SETQ |bfVar#70| (CONS |v| |bfVar#70|)))))
                                (SETQ |bfVar#67| (CDR |bfVar#67|))))
                             NIL |Conditions| NIL))
                    (SETQ |partList|
                            ((LAMBDA (|bfVar#72| |bfVar#71| |cond|)
                               (LOOP
                                (COND
                                 ((OR (ATOM |bfVar#71|)
                                      (PROGN
                                       (SETQ |cond| (CAR |bfVar#71|))
                                       NIL))
                          ...
                          ((LAMBDA (|bfVar#75| |bfVar#74|)
                             (LOOP
                              (COND
                               ((OR (ATOM |bfVar#75|)
                                    (PROGN
                                     (SETQ |bfVar#74| (CAR |bfVar#75|))
                                     NIL))
                                (RETURN NIL))
                               (#1#
                                (AND (CONSP |bfVar#74|)
                                     (PROGN (SETQ |v| (CAR |bfVar#74|)) #1#)
                                     (COND
                    ...
                    (SETQ |list|
                            ((LAMBDA (|bfVar#77| |bfVar#76| |u|)
                             ...
                             NIL |secondaries| NIL))
                    ((LAMBDA (|bfVar#78| |u| |bfVar#79| |newS|)
                       (LOOP
                        (COND
                         ((OR (ATOM |bfVar#78|)
                              (PROGN (SETQ |u| (CAR |bfVar#78|)) NIL)
                              (ATOM |bfVar#79|)
                              (PROGN (SETQ |newS| (CAR |bfVar#79|)) NIL))
                          (RETURN NIL))
                         (#1#
                          (PROGN
                           (SETQ |u|
                           ...
                           ((LAMBDA (|bfVar#81| |bfVar#80|)
                              (LOOP
                               (COND
                                ((OR (ATOM |bfVar#81|)
                                     (PROGN
                                      (SETQ |bfVar#80| (CAR |bfVar#81|))
                                      NIL))
                                 (RETURN NIL))
                                (#1#
                                 (AND (CONSP |bfVar#80|)
                                      (PROGN (SETQ |v| (CAR |bfVar#80|)) #1#)
                                      ((LAMBDA (|bfVar#82| |v'|)
                                         (LOOP
                                          (COND
                                           ((OR (ATOM |bfVar#82|)
                    ...
                    (CONS T
                          ((LAMBDA (|bfVar#89| |bfVar#88| |ms|)
                             (LOOP
                              (COND
                               ((OR (ATOM |bfVar#88|)
                                    (PROGN (SETQ |ms| (CAR |bfVar#88|)) NIL))
                                (RETURN (NREVERSE |bfVar#89|)))
                               (#1#
                                (SETQ |bfVar#89|
                                        (CONS (|find_cond| |ms| |list|)
                                              |bfVar#89|))))
...
(DEFUN |InvestigateConditions,update| (|list| |cond| |secondaries| |newS|)
  (PROG (|list2|)
    (RETURN
     (PROGN
      (SETQ |list2|
              ((LAMBDA (|bfVar#85| |bfVar#83| |sec| |bfVar#84| |old|)
                 (LOOP
                  (COND
                   ((OR (ATOM |bfVar#83|)
                        (PROGN (SETQ |sec| (CAR |bfVar#83|)) NIL)
                        (ATOM |bfVar#84|)
                        (PROGN (SETQ |old| (CAR |bfVar#84|)) NIL))
                ...
                (LOOP
                 (COND
                  ...
                  (#1#
                   (AND (CONSP |bfVar#86|)
                        (PROGN
                         (SETQ |newS2| (CAR |bfVar#86|))
                         (SETQ |morecond| (CDR |bfVar#86|))
                         #1#)
                        (SETQ |old|
                                (COND
...
(DEFUN |find_cond| (|cat| |cl|)
  (PROG (|res| |op1| |args1| |found| |cat2| |cnd| |op2| |args2|)
    (RETURN
     (COND ((SETQ |res| (LASSOC |cat| |cl|)) |res|)
           ((NULL (CONTAINED 'LENGTH |cat|)) |res|)
           ((NULL
             (AND (CONSP |cat|)
                  (PROGN
                   (SETQ |op1| (CAR |cat|))
            ...
            (PROGN
             ...
             ((LAMBDA (|bfVar#90| |cp|)
                (LOOP
                 (COND
                  ((OR (ATOM |bfVar#90|)
                       (PROGN (SETQ |cp| (CAR |bfVar#90|)) NIL) |found|)
                   (RETURN NIL))
                  (#1#
                   (COND
                    ((NULL
                    ...
                    ((NULL
                      (AND (CONSP |cat2|)
                           (PROGN
                            ...
                            #1#)))
                     '|iterate|)
                    ((NULL (EQUAL |op1| |op2|)) '|iterate|)
                    ((NULL (EQL (LENGTH |args1|) (LENGTH |args2|))) '|iterate|)
                    (#1#
                     (COND
                      ((|hacky_match_list| |args1| |args2|) (SETQ |res| |cnd|)
                       (SETQ |found| T)))))))
...
(DEFUN |hacky_match_list| (|l1| |l2|)
  (PROG (|ok|)
    (RETURN
     (PROGN
      (SETQ |ok| T)
      ((LAMBDA (|bfVar#91| |i1| |bfVar#92| |i2|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#91|) (PROGN (SETQ |i1| (CAR |bfVar#91|)) NIL)
                (ATOM |bfVar#92|) (PROGN (SETQ |i2| (CAR |bfVar#92|)) NIL)
                (NOT |ok|))
            (RETURN NIL))
           ('T (SETQ |ok| (|hacky_match| |i1| |i2|))))
...
(DEFUN |hacky_match| (|i1| |i2|)
  (PROG (|ISTMP#1| |ISTMP#2| |v|)
    (RETURN
     (COND
      ((AND (CONSP |i1|) (EQ (CAR |i1|) '|call|)
            ...
            (PROGN
             ...
             (AND (CONSP |ISTMP#1|) (EQ (CDR |ISTMP#1|) NIL)
                  (EQUAL (CAR |ISTMP#1|) |v|))))
       T)
      ((ATOM |i1|) (EQUAL |i1| |i2|)) (#1# (|hacky_match_list| |i1| |i2|))))))
  ...
  (PROG (|$ICformat_hash|)
    ...
    (RETURN
     (PROGN
      ...
      ((LAMBDA (|bfVar#95| |bfVar#93| |u| |bfVar#94| |sec|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#93|) (PROGN (SETQ |u| (CAR |bfVar#93|)) NIL)
                (ATOM |bfVar#94|) (PROGN (SETQ |sec| (CAR |bfVar#94|)) NIL))
            (RETURN (NREVERSE |bfVar#95|)))
           ('T
            (SETQ |bfVar#95|
                    (CONS (CONS |sec| (|ICformat| |u| |e|)) |bfVar#95|))))
    ...
    (RETURN
     (PROGN
      ((LAMBDA (|bfVar#96| |u|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#96|) (PROGN (SETQ |u| (CAR |bfVar#96|)) NIL))
            (RETURN NIL))
           (#1='T
            (AND
             ...
             ((LAMBDA (|bfVar#97| |v|)
                (LOOP
                 (COND
                  ((OR (ATOM |bfVar#97|)
                       (PROGN (SETQ |v| (CAR |bfVar#97|)) NIL))
                   (RETURN NIL))
                  (#1#
                   (AND (NULL (EQUAL |v| |u|))
                        (COND
                         ((OR (|member| |v| |u|)
                              ((LAMBDA (|bfVar#99| |bfVar#98| |w|)
                                 (LOOP
                                  (COND
                                   ((OR (ATOM |bfVar#98|)
                                        (PROGN
             ...
             (SETQ |l|
                     (REMDUP
                      ((LAMBDA (|bfVar#101| |bfVar#100|)
                         (LOOP
                          (COND
                           ((ATOM |bfVar#100|) (RETURN (NREVERSE |bfVar#101|)))
                           (#1#
                            (AND (CONSP |bfVar#100|)
                                 (PROGN
                                  (SETQ |v| (CAR |bfVar#100|))
    ...
    (RETURN
     (PROGN
      ...
      ((LAMBDA (|bfVar#107| |u|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#107|) (PROGN (SETQ |u| (CAR |bfVar#107|)) NIL))
            (RETURN NIL))
           (#1#
            (AND
             (OR
                   ...
                   (AND (CONSP |u'|) (EQ (CAR |u'|) '|HasCategory|)
                        ...
                        ((LAMBDA (|bfVar#109| |v|)
                           (LOOP
                            (COND
                             ((OR (ATOM |bfVar#109|)
                                  (PROGN (SETQ |v| (CAR |bfVar#109|)) NIL))
                              (RETURN NIL))
                             (#1#
              ...
              ((LAMBDA (|bfVar#111| |bfVar#110| |u|)
                 (LOOP
                  (COND
                   ...
                   (#1='T
                    (SETQ |bfVar#111|
                            (CONS (CONS (CAR |u|) (CADR |u|)) |bfVar#111|))))
...
(DEFUN |DescendCodeVarAdd| (|base| |flag| |kvec| |e|)
  (PROG (|princview| |ISTMP#1| |ISTMP#2| |op| |ISTMP#3| |types| |sig| |pred|
    ...
    (RETURN
     (PROGN
      (SETQ |princview| |kvec|)
      ((LAMBDA (|bfVar#113| |bfVar#112| |i|)
         (LOOP
          (COND ((> |i| |bfVar#112|) (RETURN (NREVERSE |bfVar#113|)))
                (#1='T
                 (AND
                  (PROGN
