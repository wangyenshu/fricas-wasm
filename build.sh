...
emmake make -j"$(nproc 2>/dev/null || echo 2)" LDFLAGS="-O2 -s FORCE_FILESYSTEM=1 -s EXPORTED_RUNTIME_METHODS=['FS_createPath','FS_createDataFile','addRunDependency','removeRunDependency'] -s TOTAL_STACK=67108864 -s INITIAL_MEMORY=1073741824" EXEEXT=".html"